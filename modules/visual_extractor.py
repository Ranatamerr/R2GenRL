...
class VisualExtractor(nn.Module):
    def __init__(self, args):
        ...
        if getattr(args, 'visual_extractor', 'biomedclip') == 'deit3':
            self.vit = timm.create_model('deit3_base_patch16_224', pretrained=True, num_classes=0)
            print("DeiT-3 loaded with pretrained ImageNet-21k weights.")
        else:
